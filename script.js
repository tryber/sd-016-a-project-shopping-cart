const ol1 = document.querySelector('.cart__items');
// const ol2 = ol1.innerHTML;
...
function replaceCart() {
  ol1.innerHTML = getSavedCartItems();
  ol1.addEventListener('click', cartItemClickListener);
}
